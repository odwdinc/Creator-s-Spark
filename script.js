    ...
    function checkAndUpdateLeaderboardForCurrentPlayer() {
        ...
        if (currentPlayerIndex >= 0) {
            ...
            if (currentPlayerIndex != leaderboardData.length-1){
                ...
                ColobParterners = [leaderboardData[leaderboardData.length-2].channelName, leaderboardData[leaderboardData.length-2].channelName, leaderboardData[currentPlayerIndex-parterner].channelName]
            }

        } else {
            ColobParterners = [leaderboardData[leaderboardData.length-2].channelName, leaderboardData[leaderboardData.length-2].channelName, leaderboardData[leaderboardData.length-parterner].channelName]
